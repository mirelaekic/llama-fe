...
export default function ProfileHeader(props) {
  console.log(props.props,"the props")
    ...
    <div>
      <Jumbotron fluid className="profile-jumbotron ">
        ...
        {matchUser === "me" ? <SettingsModal /> : null}
          ...
          <Avatar className="jumbotron-avatar img-fluid" src={matchUser === "me" ? user.imgUrl : userByID.imgUrl} alt={matchUser === "me" ? user.name : userByID.name} />
          </div> 
        </Container>
      </Jumbotron>
    </div>
